...
private val LUCKY_ITEMS = listOf("노란색", "마스크", "운동화", "셔츠", "안경")
private val CAUTIONARY_ITEMS = listOf("검정색", "체크무늬", "라면", "시계", "우산")
...
object DailyFortuneFixture {
    fun create(
        ...
        luckyItems: List<String> = LUCKY_ITEMS,
        cautionaryItems: List<String> = CAUTIONARY_ITEMS,
    ): DailyFortune =
