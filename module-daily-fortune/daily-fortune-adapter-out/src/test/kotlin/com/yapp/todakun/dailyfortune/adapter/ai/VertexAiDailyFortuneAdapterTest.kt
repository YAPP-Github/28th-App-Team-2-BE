                    ...
                    requestSpec.options(
                        match<VertexAiGeminiChatOptions> {
                            it.responseMimeType == "application/json" &&
                                it.responseSchema == vertexResponseSchema(GeneratedDailyFortune::class.java)
                        },
                    )
                }
            }
        ...
        context("responseSchema를 구성하면") {
            it("Vertex Schema proto로 변환 가능한 형태다") {
                ...
                assertVertexSchemaConvertible(
                    GeneratedDailyFortune::class.java,
                    setOf("title", "content", "luckyItems", "cautionaryItems", "categoryFortunes"),
                )
            }
        }
