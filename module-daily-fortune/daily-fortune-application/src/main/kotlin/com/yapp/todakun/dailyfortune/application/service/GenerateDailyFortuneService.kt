...
import com.yapp.todakun.dailyfortune.port.inbound.GenerateDailyFortuneUseCase
...
class GenerateDailyFortuneService(
    ...
    override fun generate(
        ...
        dailyFortuneRepository.findByMemberIdAndFortuneDate(memberId, fortuneDate)?.let { return it }
