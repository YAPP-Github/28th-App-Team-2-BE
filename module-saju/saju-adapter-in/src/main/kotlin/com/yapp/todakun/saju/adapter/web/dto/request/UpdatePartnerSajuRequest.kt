...
/** 상대방 사주 수정 요청. 생년 정보가 바뀌면 명식이 재계산된다. */
data class UpdatePartnerSajuRequest(
    ...
    @field:Schema(description = "관계 라벨", example = "FRIEND")
    @field:NotBlank(message = "관계를 선택해 주세요.")
    @field:Pattern(regexp = "^(LOVER|FRIEND|FAMILY|COLLEAGUE|ETC)$", message = "올바른 관계 값이 아닙니다.")
